...
int main()
{
    ...
    cin>>student1;
    cin>>student2;
    student1.setage(4);//modificam anul
    student1.setgen_average(6);//modificam media
    student1.setname("Dan");//modificam numele
    student1.setnumber_credits(4);//modificam nr de credite
    cout<<student1;
    cin>>grupa1;
    cin>>grupa2;
